...
if __name__ == '__main__':
    ...
    # Run it as a package
    # python -m toopazo_ulg.plot_main --bdir . --log_num 43 --time_win 300_400 --pos_vel --rpy_angles

    # python -m toopazo_ulg.plot_main
    # --pos_vel --rpy_angles --pqr_angvel --log_num 43 --man_ctrl --ctrl_alloc --time_win 2340 2344
