...
class UlgPlotBasics:
    ...
    def vehicle_attitude_0_deg(self, ulgfile, closefig):
        ...
        [fig, ax_arr] = FigureUtils.create_fig_axes(3, 1)
        ...
        PlotUtils.ax3_x1_y3(ax_arr, x_arr, xlabel, y_arr, ylabel_arr)
        # ax0.set_ylim([-30, 30])
        # ax1.set_ylim([-30, 30])
        # ax2.set_ylim([-30, 30])
    ...
    def vehicle_rates_setpoint_0(self, ulgfile, closefig):
        ...
        PlotUtils.ax4_x1_y4(ax_arr, x_arr, xlabel, y_arr, ylabel_arr)
        # ax0.set_ylim([-90, 90])
        # ax1.set_ylim([-90, 90])
        # ax2.set_ylim([-90, 90])
        # ax3.set_ylim([0, 1])
    ...
    def manual_control_setpoint_0(self, ulgfile, closefig):
        ...
        y_arr = [y0, y1, y2, y3]
        ylabel = 'RC inputs'
        PlotUtils.ax1_x1_y4(ax_arr, x_arr, xlabel, y_arr, ylabel)
        # ax.set_ylim([-1, 1])
    ...
    def vehicle_local_position_0(self, ulgfile, closefig):
        ...
        PlotUtils.ax3_x1_y6(ax_arr, x_arr, xlabel, y_arr, ylabel_arr)
        # ax0.set_ylim([-1, 1])
        # ax1.set_ylim([-1, 1])
        # ax2.set_ylim([-1, 1])
    ...
    def actuator_outputs_0(self, ulgfile, closefig):
        ...
        PlotUtils.ax1_x1_y8(ax_arr, x_arr, xlabel, y_arr, ylabel)
    ...
    def nwindow_hover_pos(self, ulgfile, closefig):
        ...
        y_arr = [y0, y1, y2]
        ylabel = 'x, y, z'
        PlotUtils.ax1_x1_y3([ax_arr[0]], x_arr, xlabel, y_arr, ylabel)

        xlabel = 'timestamp s'
        x_arr = [x_window]
        y_arr = [y0_window, y1_window, y2_window, y3_window]
        ylabel = 'std window'
        PlotUtils.ax1_x1_y4([ax_arr[1]], x_arr, xlabel, y_arr, ylabel)
        ...
        ylabel = 'x, y, z'
        PlotUtils.ax1_x1_y3([ax_arr[2]], x_arr, xlabel, y_arr, ylabel)
        ...
        ylabel = 'actuator_outputs_0'
        PlotUtils.ax1_x1_y8([ax_arr[3]], x_arr, xlabel, y_arr, ylabel)
